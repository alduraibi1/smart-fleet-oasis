...
import { Plus, Settings, Clock, DollarSign, CheckSquare } from "lucide-react";

export const MaintenanceTemplates = () => {
  const { templates } = useMaintenance();
        ...
        {templates.length === 0 ? (
          <Card className="col-span-full">
            <CardContent className="text-center py-8">
              ...
              <p className="text-muted-foreground">لا توجد قوالب صيانة</p>
            </CardContent>
          </Card>
        ) : (
